...
founders model =
    div [ class "w-75-m w-50-l w-90 center pt5" ]
        ...
        , section [ class "f4 fw1 center w-90" ]
            ...
            , p [] [ text "Both my boyfriend and his brother had gone from dissatisfying careers into Founders & Coders and out the other side into well paid, rewarding careers. They had been trying to convince me to do the course for about 2 years, telling me that I would love it, and it finally felt like the right time to take the listen to them. " ]
            , p []
